...
SRC  := src/main.c src/render.c src/sfx/post.c src/sfx/envcube.c src/physics.c src/ai.c src/audio.c src/resource.c src/world.c src/world2.c src/world_mesh.c src/car_setup.c
HDRS := src/nfsu2.h src/render.h src/physics.h src/ai.h src/audio.h src/resource.h src/debug.h src/world_mesh.h src/car_setup.h
