...
SRC  := src/main.c src/render.c src/sfx/post.c src/sfx/envcube.c src/physics.c src/ai.c src/audio.c src/resource.c src/world.c src/world2.c src/world_mesh.c
